...
public class SwaggerConfig {
    ...
    private Contact contact(){
        return new Contact("William Souza", "https://github.com/willpinhal","teste@teste.com");
    }
    ...
    public Docket docket(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.github.willpinhal.apivendas.apivendas.controllers"))
